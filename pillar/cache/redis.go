...
// NewLock creates a new Redis-based distributed lock.
func (r *RedisCache) NewLock(key string, ttl time.Duration) *RedisLock {
	return newRedisLock(r.client, key, ttl)
}
